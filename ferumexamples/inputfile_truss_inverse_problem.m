...
output_filename = 'outputfile_truss_inverse_problem.txt';
...
analysisopt.beta_target = 3.0;    % Target value for the index of reliability
...
gfundata(1).deterministic_parameter_start_value = 150 ;
